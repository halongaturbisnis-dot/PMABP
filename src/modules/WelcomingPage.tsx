      ...
      <div className="relative z-10 w-full max-w-[32rem] px-6 flex flex-col items-center text-center">
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-[#013d13] text-white font-medium shadow-[0_4px_20px_rgba(1,61,19,0.15)] hover:bg-[#022c0e] hover:shadow-[0_4px_25px_rgba(1,61,19,0.25)] transition-all cursor-pointer group"
          >
